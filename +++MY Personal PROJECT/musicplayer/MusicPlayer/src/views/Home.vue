<template>
  <div class="w-full h-screen flex flex-col overflow-hidden bg-" id="demo_wrap">
    <div
      class="flex flex-row justify-center w-full m-auto relative z-10"
      style="height:90%"
    >
      <div class="flex flex-col w-full md:w-5/12 bg-indigo-200 rounded-lg">
    ...
    >
      <div
        class="flex w-11/12 h-16 items-center justify-around m-auto bg-yellow-300"
      >
        <div
